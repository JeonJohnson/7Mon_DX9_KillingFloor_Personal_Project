...
BEGIN_MESSAGE_MAP(Spec_FormView, CFormView)
	...
	ON_BN_CLICKED(IDC_BUTTON_ObjLoad, &Spec_FormView::OnBnClickedButtonObjload)
...
void Spec_FormView::OnBnClickedButtonObjload()
{
	...
	if (Dlg.DoModal() == IDOK)
	{
		...
		Engine_Mother::Get_Instance()->Load_StaticMesh(L"Test/StaticMesh/Truck.X",
